...
def _key(r): return (r.model or 'Unknown', r.transmission_norm or 'Unknown', text.mileage_band(r.mileage))

def run_baseline(rows, cfg):
    buckets=defaultdict(list)
    for r in rows:
        if r.adj_price_usd is not None: buckets[_key(r)].append(r.adj_price_usd)
